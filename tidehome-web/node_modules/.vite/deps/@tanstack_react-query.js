...
var _queryType, _initialState, _revertState, _cache, _client, _retryer, _defaultOptions, _abortSignalConsumed, _isInitialPausedFetch, isInitialPausedFetch_fn, _dispatch, dispatch_fn, _a5;
var Query = (_a5 = class extends Removable {
  constructor(config) {
    super();
    __privateAdd(this, _isInitialPausedFetch);
    __privateAdd(this, _dispatch);
    __privateAdd(this, _queryType, void 0);
  ...
  setState(state) {
    __privateMethod(this, _dispatch, dispatch_fn).call(this, { type: "setState", state });
  }
  cancel(options) {
    var _a13, _b;
    ...
    if (this.observers.includes(observer)) {
      ...
      if (!this.observers.length) {
        if (__privateGet(this, _retryer)) {
          if (__privateGet(this, _abortSignalConsumed) || __privateMethod(this, _isInitialPausedFetch, isInitialPausedFetch_fn).call(this)) {
...
}, _queryType = new WeakMap(), _initialState = new WeakMap(), _revertState = new WeakMap(), _cache = new WeakMap(), _client = new WeakMap(), _retryer = new WeakMap(), _defaultOptions = new WeakMap(), _abortSignalConsumed = new WeakMap(), _isInitialPausedFetch = new WeakSet(), isInitialPausedFetch_fn = function() {
...
var _client5, _result, _queries, _options, _observers2, _combinedResult, _lastCombine, _lastResult, _lastQueryHashes, _observerMatches, _trackResult, trackResult_fn, _combineResult, combineResult_fn, _shouldSkipCombine, shouldSkipCombine_fn, _findMatchingObservers, findMatchingObservers_fn, _onUpdate, onUpdate_fn, _notify3, notify_fn3, _a10;
var QueriesObserver = (_a10 = class extends Subscribable {
  constructor(client, queries, options) {
    super();
    __privateAdd(this, _trackResult);
    __privateAdd(this, _combineResult);
    __privateAdd(this, _shouldSkipCombine);
    ...
    __privateAdd(this, _lastQueryHashes, void 0);
  ...
  getOptimisticResult(queries, combine) {
    ...
    return [
      result,
      (r) => {
        return __privateMethod(this, _combineResult, combineResult_fn).call(this, r ?? result, combine, queryHashes);
      },
      () => {
...
}, _combineResult = new WeakSet(), combineResult_fn = function(input, combine, queryHashes) {
  if (combine) {
  ...
  return input;
}, _shouldSkipCombine = new WeakSet(), shouldSkipCombine_fn = function() {
  var _a13;
  ...
  if (this.hasListeners()) {
    ...
    const shouldSkipCombine = __privateMethod(this, _shouldSkipCombine, shouldSkipCombine_fn).call(this);
    const previousResult = __privateGet(this, _combinedResult);
    const newResult = shouldSkipCombine ? previousResult : __privateMethod(this, _combineResult, combineResult_fn).call(this, newTracked, (_a13 = __privateGet(this, _options)) == null ? void 0 : _a13.combine);
